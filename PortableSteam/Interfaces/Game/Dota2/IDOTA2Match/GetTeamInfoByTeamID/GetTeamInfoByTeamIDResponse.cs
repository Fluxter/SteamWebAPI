namespace PortableSteam.Interfaces.Game.Dota2.IDOTA2
{
    ...
    {
        [JsonProperty("result")]
        public GetTeamInfoByTeamIDResponseData Data { get; set; }
    }
    ...
    public sealed class GetTeamInfoByTeamIDResponseData
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        [JsonConverter(typeof(JsonEnumConverter<GetTeamInfoByTeamIDResponseStatus>))]
        public GetTeamInfoByTeamIDResponseStatus Status { get; set; }
        /// <summary>
