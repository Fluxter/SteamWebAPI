namespace PortableSteam.Interfaces.Game.Dota2.IDOTA2
{
    ...
    {
        [JsonProperty("result")]
        public GetMatchHistoryBySequenceNumResponseData Data { get; set; }
    }
    ...
    public sealed class GetMatchHistoryBySequenceNumResponseData
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        [JsonConverter(typeof(JsonEnumConverter<GetMatchHistoryBySequenceNumResponseStatus>))]
        public GetMatchHistoryBySequenceNumResponseStatus Status { get; set; }
        /// <summary>
