namespace PortableSteam.Interfaces.Game.Dota2.IDOTA2
{
    ...
    {
        [JsonProperty("result")]
        public GetTournamentPlayerStatsResponseData Data { get; set; }
    }
    ...
    public sealed class GetTournamentPlayerStatsResponseData
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        [JsonConverter(typeof(JsonEnumConverter<GetTournamentPlayerStatsResponseStatus>))]
        public GetTournamentPlayerStatsResponseStatus Status { get; set; }
        /// <summary>
