namespace PortableSteam.Interfaces.Game.Generic.IEconItems
{
    ...
    {
        [JsonProperty("result")]
        public GetPlayerItemsResponseData Data { get; set; }
    }
    ...
    public sealed class GetPlayerItemsResponseData
    {
        ...
        /// </summary>
        [JsonProperty("status")]
        [JsonConverter(typeof(JsonEnumConverter<GetPlayerItemsResponseStatus>))]
        public GetPlayerItemsResponseStatus Status { get; set; }
        /// <summary>
