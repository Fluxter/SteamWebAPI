namespace PortableSteam.Interfaces.General.ISteamUserStats
{
    ...
    {
        [JsonProperty("game")]
        public GetSchemaForGameResponseGame Data { get; set; }
    }
    ...
    public sealed class GetSchemaForGameResponseGameStats
    {
        ...
        public List<GetSchemaForGameResponseAchievements> Achievements { get; set; }
        [JsonProperty("stats")]
        public List<GetSchemaForGameResponseStats> Stats { get; set; }
    }
