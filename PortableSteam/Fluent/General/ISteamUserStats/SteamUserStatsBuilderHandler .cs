...
{
    using PortableSteam.Fluent.General.ISteamUserStats;
    ...
    public class SteamUserStatsBuilderHandler : SteamBaseBuilderHandler
    {
        ...
        {
            return new GetGlobalAchievementPercentagesForAppBuilder(new GetGlobalAchievementPercentagesForAppRequest(this.Key) { GameID = gameID });
        }
        /// <summary>
        ...
        public GetGlobalStatsForGameBuilder GetGlobalStatsForGame(int gameID, int count, params string[] names)
        {
            ...
            return new GetGlobalStatsForGameBuilder(new GetGlobalStatsForGameRequest(this.Key) { AppID = gameID, Count = count, Names = names });
        }
        /// <summary>
        ...
        {
            return new GetPlayerAchievementsBuilder(new GetPlayerAchievementsRequest(this.Key) { AppID = appID, SteamID = identity.SteamID });
        }
        /// <summary>
        /// Get schema for game.
        /// </summary>
        ...
        {
            return new GetUserStatsForGameBuilder(new GetUserStatsForGameRequest(this.Key) { AppID = appID, SteamID = identity.SteamID });
        }
