// ------------------------------------------------------------------------------------------------
//  <copyright file="GetNumberOfCurrentPlayersBuilder.cs"
//             company="fluxter.net">
...
namespace Fluxter.SteamWebAPI.Fluent.General.ISteamUserStats
{
    ...
    public class GetNumberOfCurrentPlayersBuilder : SteamBaseBuilder<GetNumberOfCurrentPlayersRequest,
        GetNumberOfCurrentPlayersResponse, GetNumberOfCurrentPlayersBuilder>
    {
