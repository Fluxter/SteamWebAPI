// ------------------------------------------------------------------------------------------------
//  <copyright file="GetUserStatsForGameBuilder.cs"
//             company="fluxter.net">
...
namespace Fluxter.SteamWebAPI.Fluent.General.ISteamUserStats
{
    ...
    public class GetUserStatsForGameBuilder : SteamBaseBuilder<GetUserStatsForGameRequest, GetUserStatsForGameResponse,
        GetUserStatsForGameBuilder>
    {
