// ------------------------------------------------------------------------------------------------
//  <copyright file="GetSchemaForGameBuilder.cs"
//             company="fluxter.net">
...
namespace Fluxter.SteamWebAPI.Fluent.General.ISteamUserStats
{
    ...
    public class GetSchemaForGameBuilder : SteamBaseBuilder<GetSchemaForGameRequest, GetSchemaForGameResponse,
        GetSchemaForGameBuilder>
    {
