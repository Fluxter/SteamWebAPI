// ------------------------------------------------------------------------------------------------
//  <copyright file="ResolveVanityURLBuilder.cs"
//             company="fluxter.net">
...
namespace Fluxter.SteamWebAPI.Fluent.General.ISteamUser
{
    ...
    public class ResolveVanityURLBuilder : SteamBaseBuilder<ResolveVanityURLRequest, ResolveVanityURLResponse,
        ResolveVanityURLBuilder>
    {
