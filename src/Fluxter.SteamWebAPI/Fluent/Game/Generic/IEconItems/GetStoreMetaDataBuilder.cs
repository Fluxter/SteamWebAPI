// ------------------------------------------------------------------------------------------------
//  <copyright file="GetStoreMetaDataBuilder.cs"
//             company="fluxter.net">
...
namespace Fluxter.SteamWebAPI.Fluent.Game.Generic.IEconItems
{
    ...
    public class GetStoreMetaDataBuilder : SteamBaseBuilder<GetStoreMetaDataRequest, GetStoreMetaDataResponse,
        GetStoreMetaDataBuilder>
    {
